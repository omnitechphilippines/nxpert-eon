  ...
  Widget build(BuildContext context) {
    return PlatformLayoutWrapper(
      child: Scaffold(
        ...
        appBar: AppBar(title: const Text('MaintenanceView'), centerTitle: true, automaticallyImplyLeading: false),
        body: const Center(child: Text('MaintenanceView is working', style: TextStyle(fontSize: 20))),
      ),
    );
  }
}
