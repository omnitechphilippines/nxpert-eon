...
class KdPalletLayoutPage extends StatelessWidget {
  const KdPalletLayoutPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Column(
        spacing: 8,
        children: <Widget>[
          HeaderBanner(subtitle: 'PALLET LAYOUT'),
          Expanded(child: Center(child: Text('Pallet Layout'))),
          Footer(),
        ],
      ),
    );
