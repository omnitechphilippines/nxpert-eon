...
class MprC4Page extends StatelessWidget {
  const MprC4Page({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Column(
        spacing: 8,
        children: <Widget>[
          HeaderBanner(subtitle: 'MONTHLY PRODUCTION REPORT (C4)'),
          Expanded(child: Center(child: Text('Monthly Production Report (C4)'))),
          Footer(),
        ],
      ),
    );
