...
class MprAdcPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Column(
        spacing: 8,
        children: <Widget>[
          HeaderBanner(subtitle: 'MONTHLY PRODUCTION REPORT (ADC)'),
          Expanded(child: Center(child: Text('Monthly Production Report (ADC)'))),
          Footer(),
        ],
      ),
    );
