...
class MprKdPage extends StatelessWidget {
  const MprKdPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Column(
        spacing: 8,
        children: <Widget>[
          HeaderBanner(subtitle: 'MONTHLY PRODUCTION REPORT (KD)'),
          Expanded(child: Center(child: Text('Monthly Production Report (KD)'))),
          Footer(),
        ],
      ),
    );
