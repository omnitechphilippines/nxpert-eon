...
class PlanUploaderPage extends StatelessWidget {
  const PlanUploaderPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Column(
        spacing: 8,
        children: <Widget>[
          HeaderBanner(subtitle: 'PLAN UPLOADER'),
          Expanded(child: Center(child: Text('Plan Uploader'))),
          Footer(),
        ],
      ),
    );
