...
class PalletEntryPage extends StatelessWidget {
  const PalletEntryPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Column(
        spacing: 8,
        children: <Widget>[
          HeaderBanner(subtitle: 'PALLET LOADING'),
          Expanded(child: Center(child: Text('Pallet Loading'))),
          Footer(),
        ],
      ),
    );
