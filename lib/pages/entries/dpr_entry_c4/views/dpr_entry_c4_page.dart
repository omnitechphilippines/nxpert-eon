...
class DprEntryC4Page extends StatelessWidget {
  const DprEntryC4Page({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Column(
        spacing: 8,
        children: <Widget>[
          HeaderBanner(subtitle: 'DAILY PRODUCTION REPORT (C4)'),
          Expanded(child: Center(child: Text('Daily Production Report (C4)'))),
          Footer(),
        ],
      ),
    );
