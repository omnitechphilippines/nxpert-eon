...
class DprEntryAdcPage extends StatelessWidget {
  const DprEntryAdcPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Column(
        spacing: 8,
        children: <Widget>[
          HeaderBanner(subtitle: 'DAILY PRODUCTION REPORT (ADC)'),
          Expanded(child: Center(child: Text('Daily Production Report (ADC)'))),
          Footer(),
        ],
      ),
    );
