...
- ✅ **Web (GitHub Pages):**  
  👉 [NXPERT EON](https://omnitechphilippines.github.io/nxpert-eon/)
...
- 💻 **Windows (.zip):**  
  👉 [Download ZIP](https://github.com/omnitechphilippines/nxpert-eon/releases/latest/download/nxpert_eon_windows.zip)

- 📱 **Android (.apk):**  
  👉 [Download APK](https://github.com/omnitechphilippines/nxpert-eon/releases/latest/download/nxpert_eon_android.apk)
...
## 📞 Contact
- N-PAX / NXPERT Team
- 📧 omnitechphilippines@gmail.com
- 🌐 [https://omnitechphilippines.com](https://omnitechphilippines.com)
- 📂 [GitHub Repository](https://github.com/omnitechphilippines/nxpert-eon)
